...
_This post is also posted on [dev.to](https://dev.to/raymelon/work-with-a-dev-agency-better-yet-start-one-5gp4), [Hashnode](https://raymel.hashnode.dev/work-with-a-dev-agency-better-yet-start-one), and [LinkedIn](https://www.linkedin.com/pulse/work-dev-agency-better-yet-start-one-raymel-francisco-d5itc)_
...
As aspiring trainees, me and my friends went to business districts. We started with major companies, sent cold emails to local startups, and hopped across local dev agencies — with the hopes of anyone taking us in. -->

<!-- For me, it's a random choice. "Bahala na" is a common Filipino concept, which means it's up to the Almighty's hands or fate. As long as one of these companies takes me, I will pass my third year — one year closer to completing my CS degree. Simple as that.
